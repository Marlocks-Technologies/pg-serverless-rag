...
async function uploadDocument(file) {
  ...
  reader.onload = async () => {
    ...
    const response = await fetch('https://lh8dbbvwbb.execute-api.eu-west-1.amazonaws.com/dev/documents', {
      method: 'POST',
      headers: {
...
```bash
# List all documents
curl https://lh8dbbvwbb.execute-api.eu-west-1.amazonaws.com/dev/documents

# Filter by category
curl "https://lh8dbbvwbb.execute-api.eu-west-1.amazonaws.com/dev/documents?category=technical"

# Filter by status
curl "https://lh8dbbvwbb.execute-api.eu-west-1.amazonaws.com/dev/documents?status=completed&limit=10"
```
...
async function listDocuments(filters = {}) {
  ...
  const response = await fetch(
    `https://lh8dbbvwbb.execute-api.eu-west-1.amazonaws.com/dev/documents?${params}`
  );
...
```bash
curl https://lh8dbbvwbb.execute-api.eu-west-1.amazonaws.com/dev/documents/abc123-def456-ghi789
```
...
async function getDocumentDetails(documentId) {
  const response = await fetch(
    `https://lh8dbbvwbb.execute-api.eu-west-1.amazonaws.com/dev/documents/${documentId}`
  );
...
```bash
curl -X DELETE https://lh8dbbvwbb.execute-api.eu-west-1.amazonaws.com/dev/documents/abc123-def456-ghi789
```
...
function DocumentUploader() {
  ...
  async function handleFileUpload(event) {
    ...
    try {
      ...
      // Upload to API
      const response = await fetch(
        'https://lh8dbbvwbb.execute-api.eu-west-1.amazonaws.com/dev/documents',
        {
          method: 'POST',
